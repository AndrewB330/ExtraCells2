...
public class PartFluidPlaneFormation extends PartWithUpgradesInventory implements IFluidSlotPartOrBlock, IGridTickable {
    ...
    public PartFluidPlaneFormation() {
        super(1, PartEnum.FLUID_PANE_FORMATION.getUpgradesMaxLimit());
    }
