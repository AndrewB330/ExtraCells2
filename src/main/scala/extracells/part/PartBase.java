...
public abstract class PartBase implements IPart, IGridHost, IActionHost, IPowerChannelState {
    ...
    public void addToWorld() {
        ...
        this.gridBlock = new GridBlockBase(this);
    ...
    public GridBlockBase getGridBlock() {
    ...
    public ItemStack getItemStack(PartItemStack type) {
        ItemStack stack = new ItemStack(ItemEnum.PARTITEM.getItem(), 1, PartEnum.getPartID(this));
