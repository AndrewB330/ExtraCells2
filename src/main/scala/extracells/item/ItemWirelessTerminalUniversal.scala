...
object ItemWirelessTerminalUniversal extends ItemECBase with WirelessTermBase with IWirelessFluidTermHandler with IWirelessTermHandler with EssensiaTerminal with CraftingTerminal{
